...
export async function getRankingData(
  ...
  try {
    ...
    for (const card of [ranking.leadsFinished, ranking.activitiesDone, ranking.conversionRate, ranking.leadsOpened, ranking.meetingsScheduled, ranking.meetingsHeld, ranking.hitRate]) {
