...
const statusConfig: Record<LeadStatus, { label: string; className: string }> = {
  ...
  won: { label: 'Ganho', className: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-300' },
...
const meetimeConfig: Record<LeadStatus, { label: string; className: string }> = {
  ...
  won: { label: 'GANHO', className: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900 dark:text-emerald-300' },
