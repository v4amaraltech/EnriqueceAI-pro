...
const INDUSTRY_OPTIONS = [
  { value: 'information technology & services', label: 'Tecnologia da Informação' },
  { value: 'computer software', label: 'Software / SaaS' },
  { value: 'internet', label: 'Internet' },
  { value: 'financial services', label: 'Serviços Financeiros' },
  { value: 'hospital & health care', label: 'Saúde' },
  { value: 'education management', label: 'Educação' },
  { value: 'retail', label: 'E-commerce / Varejo' },
  { value: 'hospitality', label: 'Hotelaria e Turismo' },
  { value: 'real estate', label: 'Imobiliário' },
  { value: 'management consulting', label: 'Consultoria' },
  ...
  { value: 'mechanical or industrial engineering', label: 'Manufatura / Industrial' },
  { value: 'logistics & supply chain', label: 'Logística e Transporte' },
  { value: 'food & beverages', label: 'Alimentos e Bebidas' },
  { value: 'automotive', label: 'Automotivo' },
  { value: 'insurance', label: 'Seguros' },
  { value: 'oil & energy', label: 'Energia' },
  { value: 'farming', label: 'Agronegócio' },
];
...
export function ApolloSearchForm({ onSearch, isLoading }: ApolloSearchFormProps) {
  ...
  function handleSearch() {
    ...
    const allKeywords = [
      ...industries,
      ...splitCommaSeparated(keywords),
    ];
    if (allKeywords.length) params.organizationKeywords = allKeywords;
