...
export async function updateLead(
  ...
  const safeFields = ['razao_social', 'nome_fantasia', 'email', 'telefone', 'status', 'notes', 'socios', 'instagram', 'linkedin', 'website', 'first_name', 'last_name', 'job_title', 'lead_source', 'is_inbound', 'email_bounced_at'];
