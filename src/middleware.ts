...
const API_PUBLIC_PREFIXES = ['/api/health', '/api/webhooks', '/api/track', '/api/auth/callback', '/api/auth/confirm', '/api/v1', '/api/feedback', '/api/admin', '/api/workers', '/api/unsubscribe'];
